...
function Game() {
  ...
  let img1 =
    lipsyncs.q1.id === 90
      ? "https://i.ytimg.com/vi/YlnNt7D2OdA/hqdefault.jpg"
      : lipsyncs.q1.image_url;
  let img2 =
    lipsyncs.q2.id === 90
      ? "https://i.ytimg.com/vi/YlnNt7D2OdA/hqdefault.jpg"
      : lipsyncs.q2.image_url;
  useEffect(() => {
    axios
      .get(`http://www.nokeynoshade.party/api/lipsyncs/${randomLipsync()}`)
      .then(response => {
    ...
    <div>
      ...
      {lipsyncs.q1 && (
        <div className="main">
          ...
          <div>
            <button onClick={handleClick} name="neither">
              neither!
            </button>

            <button onClick={handleClick} name="both">
              both♥♥
            </button>
          </div>
